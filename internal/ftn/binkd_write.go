...
func writeFreshBinkdConf(out *strings.Builder, cfg BinkdConfig, outbound BinkdOutbound, logPath, secureIn, insecureIn, v3mailPath, boardName, sysop, location string) {
	...
	for _, name := range names {
		fmt.Fprintf(out, "domain %s %s %d\n", name, outbound.For(name), cfg.Domains[name])
	}
...
func rewriteBinkdConf(out *strings.Builder, content string, cfg BinkdConfig, outbound BinkdOutbound, logPath, secureIn, insecureIn, v3mailPath, boardName, sysop, location string) {
